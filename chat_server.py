...
# ==============================================================================
                ...
                poem_res = self.sonnet.get_poem(poem_num)
                poem = '\n'.join(poem_res) if isinstance(poem_res, list) else str(poem_res)
                print('here:\n', poem)
...
# ==============================================================================
                ...
                term = msg["target"]
                from_name = self.logged_sock2name[from_sock]
                search_res = self.indices[from_name].search(term)
                
                if isinstance(search_res, list):
                    search_rslt = '\n'.join([x[1] for x in search_res])
                else:
                    search_rslt = str(search_res)
